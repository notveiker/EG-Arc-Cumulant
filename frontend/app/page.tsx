...
const SHOWCASE: Showcase[] = [
  {
    ...
    specs: ["One collateral leg, many markets", "Correlated exposure in a single ticket", "Settles as one Arc-local position"],
  ...
  },
  {
    ...
    specs: ["Set your own μ and σ", "Trade your curve against the market's", "Continuous payout, settles on Arc"],
...
const PIPE: Array<{ name: string; sub: string; Icon: (p: IconProps) => React.ReactElement }> = [
  ...
  { name: "Arc settlement", sub: "Arc USDC", Icon: IconCube },
];
...
export default function HomePage() {
  ...
  const stats = useMemo(
    () => [
      ...
      { label: "USDC vault APY", value: pct(vaultApy, 2), note: bestVault?.name ?? "Best Arc yield source" },
    ],
      ...
      <PageFrame wide>
        ...
        <div className="lp-shell">
          ...
          <section className="lp-hero">
            <div>
              <div className="lp-eyebrow">Arc testnet · structured markets</div>
              <h1 className="lp-hero-title">
                Structured products on <em>live market probability</em>
              </h1>
              <p className="lp-hero-sub">
                Cumulant turns prediction-market pricing into four composable products: distribution
          ...
          <section className="scroll-fade">
            <div className="lp-stats" aria-label="Live Cumulant metrics">
              {stats.map((s) => (
          ...
          <section className="lp-section scroll-fade" id="how">
            <div className="lp-head">
              <div className="lp-eyebrow">How Cumulant works</div>
              <h2>Market pricing in, an on-chain position out</h2>
              <p>Four stages take a live quote to a settled Arc position.</p>
            </div>
          ...
          <footer className="lp-footer scroll-fade">
            <div className="lp-foot-main">
              <div className="lp-footer-brand">
                ...
                <p>Structured prediction-market products, collateralized in USDC and settled on Arc.</p>
              </div>
            ...
            <div className="lp-footer-base">
              <span>© 2026 Cumulant · Arc testnet · USDC-collateralized</span>
              <span>Built for Circle Arc</span>
            </div>
          </footer>
        </div>
      </PageFrame>
