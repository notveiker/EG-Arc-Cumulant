            ...
            <div style={PANEL}>
              ...
              {result && (
                <div style={{ marginTop: 12, fontFamily: FM, fontSize: 12, color: C.green }}>
                  ...
                  <a href={arcscanTxUrl(result.txHash)} target="_blank" rel="noreferrer" style={{ color: C.tealLight }}>
                    ...
                    <div key={p.id} className="dc-pos">
                      ...
                      {cr && (
                        <div style={{ marginTop: 8, fontFamily: FM, fontSize: 11, color: C.textMuted, display: "flex", flexWrap: "wrap", gap: 12 }}>
                          ...
                          {cr.close_tx_hash && (
                            <a href={arcscanTxUrl(cr.close_tx_hash)} target="_blank" rel="noreferrer" style={{ color: C.tealLight }}>
                              tx ↗
                            </a>
                          )}
                        </div>
                        ...
                        <div style={{ display: "grid", gap: 2 }}>
                          ...
                          <span style={{ fontFamily: FM, fontSize: 11, color: C.textMuted }}>
                            ...
                            {p.settle_tx_hash ? (
                              <>
                                {" · "}
                                <a href={arcscanTxUrl(p.settle_tx_hash)} target="_blank" rel="noreferrer" style={{ color: C.tealLight }}>
                                  payout
                                </a>
                              </>
                            ) : null}
