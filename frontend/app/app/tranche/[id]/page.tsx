  ...
  return (
    <>
      ...
      <PageFrame>
        ...
        <style dangerouslySetInnerHTML={{ __html: TRANCHE_DETAIL_CSS }} />
      </PageFrame>
    </>
  );
}
...
function TrancheBuyPanel({
  ...
  async function handlePrimary() {
    ...
    try {
      ...
      const result = await ppnDeposit({
        ...
        // to the on-chain contract's 1..365 day range so we don't emit a
  ...
  async function handleExecuteSell() {
    ...
    try {
      ...
      setSellRfq(null);
      // Surface the on-chain sell tx hash so the explorer link renders after tx.
      setTxStage("done");
  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        {!appConnected ? (
          // Disconnected: the button OPENS THE WALLET PICKER (the wallet SDK's
