...
const SECTIONS: DocSection[] = [
  {
    ...
    label: "Overview",
    pages: [
      { id: "what-is-cumulant", label: "What is Cumulant",   render: () => <WhatIsCumulant /> },
...
function WhatIsCumulant() {
  return (
    <>
      <P>
        Cumulant is a structured-products protocol built on public
        prediction markets. Upstream venues expose a flat universe of
        single-question YES/NO markets; Cumulant composes that universe
      ...
      <P>
        ...
        trading. Cumulant addresses this gap by introducing three
      ...
      <P>
        Cumulant targets three user profiles: allocators seeking
  ...
  return (
    <>
      <P>
        ...
        an Express backend, and Solidity contracts deployed on Arc
      ...
      <UL
        items={[
          ...
          <>
            <B>On-chain</B> — Solidity contracts under{" "}
            <Code>contracts/</Code> deployed to Arc testnet.
            They create prediction
            markets, buy positions, resolve, and claim through
  ...
  return (
    <>
      <P>
        ...
        <Code>package.json</Code> and can be built in isolation. Shared
...
npx tsc --noEmit`}
      ...
      <P>
        ...
        <Code>frontend/.env.local</Code>. The backend&apos;s default
        upstream endpoints do not require paid credentials.
      </P>
      <SubHeading>On-chain contracts</SubHeading>
      <P>
        The Solidity contract suite under <Code>contracts/</Code> is
        deployed to Arc testnet. It exposes USDC minting plus
        prediction-market create, buy, resolve, and claim flows used by
        the local Arc execution harness.
      </P>
    </>
  );
}
  ...
  return (
    <>
      ...
      <P>
        ...
        upstream venue propagate to every Cumulant position that
      ...
      <P>
        ...
        on-chain contracts: bugs in settlement logic, upgrade-authority
        compromise, and oracle integration errors. The contracts
        included in the repository target Arc testnet and have not
        been audited.
      </P>
  ...
  return (
    <>
      ...
      <Faq
        ...
        a="A hackathon team building Cumulant as a Arc testnet structured prediction-market prototype."
      />
      <Faq
