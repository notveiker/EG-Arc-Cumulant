...
// Map user inputs to a real Cumulant basket from the frontend's universe so
      ...
      >
        ...
        <div style={{ position: "relative", marginBottom: 28, maxWidth: 620 }}>
          ...
          <div style={{ fontSize: 13, color: C.textSecondary, fontFamily: FS, lineHeight: 1.55 }}>
            Set the capital, objective, and horizon. Cumulant maps the request to live baskets and linked risk slices.
          </div>
        </div>
...
function AllocationRow({ a }: { a: Allocation }) {
  ...
  const title = d.basket_name || "Cumulant basket";
