 ...
 * spread, and underwriting premium so the portfolio composer (which
 * cites tranche APYs back to the allocator) and the user-facing buy
 * panel never disagree. When the model changes, keep this file in
